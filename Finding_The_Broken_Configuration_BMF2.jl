...
a = readdlm("OUT_ExSSs_BMFv2_1250Set1_mY_mY_From_118.txt")
last_index = floor(Int, a[size(a,1), 1]) 

print(string(last_index, "\n"))

pars = CSV.File("InputFiles\\ARGS_BMFv2_Mass_Par_1250Set1.csv") # Core parameters
...
key_names = (:g, :mY, :gY, :mA, :kD, :mB, :mU, :e0, :eP, :bA, :bI, :mAs);
