## Running in julia terminal
	...
	iARG = (mm = "BMFv2",  # Label for motif file
       ...
       pars = CSV.File("InputFiles\\ARGS_BMFv2_Mass_Par_1250Set2.csv"); # Core parameters
       key_names = (:g, :mY, :gY, :mA, :kD, :mB, :mU, :e0, :eP, :bA, :bI, :mAs); #The names of the parameters of the systems
