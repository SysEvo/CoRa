...
p = Dict([
    ...
    :mY  => 1.0,       # Y maximum synthesis rate dependent of Y1 (nM/min)
    ...
    :mU  => 0.123,     # U synthesis rate dependent of Y (nM/min)
    ...
    :m0  => 12.5,      # Y0 synthesis rate dependent of W (nM/min)
    :m1  => 0.15,      # Y1 maximum synthesis rate dependent of Y0 (nM/min)
